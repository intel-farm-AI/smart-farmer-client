        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-lime-50 p-8 rounded-xl shadow hover:scale-105 transition-transform">
              <FaStethoscope className="w-16 h-16 mb-4 mx-auto text-lime-700" />
            ...
            <div className="bg-lime-50 p-8 rounded-xl shadow hover:scale-105 transition-transform">
              <FaLeaf className="w-16 h-16 mb-4 mx-auto text-lime-700" />
            ...
            <div className="bg-lime-50 p-8 rounded-xl shadow hover:scale-105 transition-transform">
              <FaCloudSun className="w-16 h-16 mb-4 mx-auto text-lime-700" />
              <h3 className="text-xl font-semibold text-lime-700 mb-2 text-center">Perkiraan Cuaca</h3>
